            ...
            <div className="row gx-5 gy-4">
              <div className="col-md-8 order-2 order-md-1">
                ...
                {/*<Link href="/writeareview">
                      <a 
                      className="btn fw-600  border mx-2 text-decoration-none text-dark"
                      style={{ padding: "10px 15px" }}>Add Photos</a>
                </Link>*/}


                <Link href="javascript:void(0)" onClick={() => navigator.share}>
                      <a 
                      className="btn fw-600  border mx-2 text-decoration-none text-dark"
                      style={{ padding: "10px 15px" }}>Share</a>
                </Link>
              ...
              {/*  <Link href="/writeareview">
                      <a 
                      className="btn fw-600  border mx-2 text-decoration-none text-dark"
                      style={{ padding: "10px 15px" }}>Save</a>
                </Link>*/}
...
<iframe src={`https://maps.google.com/maps?q=${business.address.coordinates.long},${business.address.coordinates.lat}&z=15&output=embed`} width="360" height="270" frameBorder="0" style={{border:0}}></iframe>
